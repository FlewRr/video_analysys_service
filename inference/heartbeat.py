...
class HeartbeatSender:
    ...
    def send_heartbeat(self, scenario_id: str):
        ...
        try:
            ...
            self.producer.flush()
            logger.debug(f"[HeartbeatSender] Sent heartbeat for scenario {scenario_id}")
    ...
    def start_heartbeat(self, scenario_id: str):
        ...
        logger.info(f"[HeartbeatSender] Started heartbeat thread for scenario {scenario_id}")
    ...
    def stop(self):
        ...
        if self.producer:
            self.producer.close()
        logger.info("[HeartbeatSender] Stopped heartbeat sender") 